                    ...
                    <div id="inbox" class="tab-content">
                        ...
                        <?php foreach(\$received as \$msg): ?>
                            <div class="p-4 border-b border-gray-100 <?= \$msg['is_read'] ? 'bg-white' : 'bg-blue-50' ?>">
                                ...
                                <h4 class="font-bold text-md mb-1"><?= htmlspecialchars(\$msg['subject']) ?></h4>
                                <p class="text-gray-700 text-sm whitespace-pre-wrap mb-2"><?= htmlspecialchars(\$msg['body']) ?></p>
                                <?php if(\$msg['attachment_path']): ?>
                                    <a href="<?= htmlspecialchars(\$msg['attachment_path']) ?>" target="_blank" class="inline-flex items-center gap-1 text-xs text-blue-600 bg-blue-50 px-2 py-1 rounded">dY"Z View Attachment</a>
                                <?php endif; ?>
                            </div>
                        <?php endforeach; ?>
                    </div>
...
$c = str_replace($oldInbox, $newInbox, $c);
