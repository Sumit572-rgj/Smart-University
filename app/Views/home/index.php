...
<body>
    ...
    <nav class="navbar">
        ...
        <a href="<?= BASE_URL ?>auth/login" class="login-btn-left">
    ...
    <main class="hero">
        ...
        <div class="animate-on-scroll delay-200">
            <a href="<?= BASE_URL ?>auth/login" class="login-btn-left" style="padding: 1rem 3rem; font-size: 1.25rem;">Get Started Now &rarr;</a>
        </div>
    </main>
        ...
        <div class="footer-grid">
            ...
            <div class="animate-on-scroll delay-100">
                ...
                <ul>
                    ...
                    <li><a href="<?= BASE_URL ?>auth/login">Login Portal</a></li>
                </ul>
            </div>
            <div class="animate-on-scroll delay-200">
                <h4>Support</h4>
