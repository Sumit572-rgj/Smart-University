...
$pattern = '/<div class="flex items-center mb-6 border-b pb-4">.*?<h2 class="text-2xl font-bold">.*?<\/div>.*?<\/div>/s';
...
$newHeader = <<<HTML
                    <div class="flex items-center mb-6 border-b pb-4" style="flex-wrap: wrap; gap: 1.5rem;">
                        <div style="position: relative;">
                            ...
                            <form action="/cit_ums/student/profile" method="POST" enctype="multipart/form-data" id="profile-pic-form" style="position: absolute; bottom: -5px; right: -5px; margin: 0;">
...
$c = preg_replace($pattern, $newHeader, $c, 1);
file_put_contents($f, $c);
echo "Avatar UI updated robustly.";
