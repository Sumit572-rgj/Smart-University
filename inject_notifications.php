...
$notificationHtml = '
            <div class="user-menu" style="display: flex; align-items: center; gap: 1rem;">
                ...
                ?>
                <div class="notification-bell" style="position: relative; cursor: pointer;" onclick="document.getElementById(\'notif-dropdown\').classList.toggle(\'hidden\')">
                    ...
                    <div id="notif-dropdown" class="hidden shadow-lg border border-gray-200" style="position: absolute; right: 0; top: 30px; background: white; width: 300px; border-radius: 0.5rem; z-index: 50;">
                ...
                <a href="/cit_ums/auth/logout" class="btn btn-primary">Logout</a>
            </div>
';
...
foreach ($iterator as $file) {
    if ($file->isFile() && $file->getExtension() === 'php') {
        ...
        // Let\'s replace the generic user-menu with the notification-enabled one
        // Pattern: <div class="user-menu">...</div>
        $pattern = '/<div class="user-menu">.*?<\/div>/s';
        
        if (preg_match($pattern, $content)) {
            $newContent = preg_replace($pattern, $notificationHtml, $content);
            file_write_contents($file->getRealPath(), $newContent);
