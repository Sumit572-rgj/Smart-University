...
<div class="dashboard-layout">
    ...
    <main class="main-content">
        <header class="topbar shadow-sm">
            ...
            <div class="welcome font-medium text-lg">Warden Management</div>
            </div>
        ...
        <div class="content-wrapper">
            ...
            <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200 mb-6">
                <h3 class="text-lg font-bold mb-4">Add New Warden</h3>
                <form action="<?= BASE_URL ?>warden" method="POST" class="grid" style="grid-template-columns: 1fr 1fr; gap: 1rem;">
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                <div class="p-4 border-b border-gray-200">
                    <h3 class="text-lg font-bold">Warden List</h3>
                </div>
                <div class="table-container">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?= htmlspecialchars($warden['id']) ?></td>
                                <td><span class="font-medium"><?= htmlspecialchars($warden['username']) ?></span></td>
                                <td><?= htmlspecialchars($warden['email']) ?></td>
                                <td><?= date('d M Y', strtotime($warden['created_at'])) ?></td>
                                <td>
                                    <form action="<?= BASE_URL ?>warden" method="POST" onsubmit="return confirm('Delete this warden?');" style="display:inline;">
